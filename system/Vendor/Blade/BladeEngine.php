<?php
namespace Lightroom\Vendor\Blade;
...
class BladeEngine implements TemplateEngineInterface
{
    ...
    public function init() : void
    {
        ...
        $this->loader = new Blade($this->baseDirectory, $this->compilationDirectory);

        // get closure function for class
        $closure = function(){ return $this; };

        // create function
        func()->create('BladeEngine', $closure->bindTo($this, static::class))->attachTo(GlobalFunctions::class);

        // load functions
        include_once 'BladeFunctions.php';
    }
    ...
    /**
     * @method BladeEngine setTemplateBaseDirectory
    ...
    /**
     * @method BladeEngine setCompilationDirectory
     * @param string $baseDirectory
     * @return void
     */
    ...
    /**
     * @method BladeEngine setFileExtension
    ...
    /**
     * @method BladeEngine bulkConfiguration
    ...
    /**
     * @method BladeEngine loadCustomPath
     * @param string $path 
     * @param string &$basename
     * @return Blade
     */
    public function loadCustomPath(string $path, string &$basename = '') : Blade 
    {
        // get base name
        ...
        if ($environment === null) :
            ...
            // load blade
            $environment = new Blade($directory, $this->compilationDirectory);
    ...
    /**
     * @method BladeEngine includeHeader
     * @return void
     */
    ...
    /**
     * @method BladeEngine includeFooter
     * @return void
     */
    ...
    /**
     * @method BladeEngine cacheOutput
     * @param string $view
     * @return void
     */
